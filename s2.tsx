                                          ...
                                          <React.Fragment>
                                              <List component="div" disablePadding >
                                                  ...
                                                  <ListItem  button className={classes.nested} onClick={() => handleClick(expandoName)}>
                                                      ...
                                                      <ListItemText disableTypography  primary={expandoName} />
                                                          ...
                                                          return(
                                                              <React.Fragment>
                                                                  ...
                                                                  <List component="div" disablePadding  >
                                                                      ...
                                                                      onDragStart={(event) => onDragStart(event, thisnodeName)} draggable
                                                                      >
                                                                      ...
                                                                      <Box p={1}>
                                                                          <div className={thisnodeName}> </div>
                                                                        </Box>
                                                                        <Box p={1} className='textSideBar'>
